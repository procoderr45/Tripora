...
export default function (userData: User, planData: Plan) {
    ...
    const overviewRoleOfModel = `
        ...
        3. If exact location images are unavailable, use **real similar or contextually relevant** ones (e.g., for Dwarka, use coastal temple or sea-related real Pexels images, if place is know for nature view use nature views).
        ...
        8. give atleast 4-8 images per activity of each day
        `;
